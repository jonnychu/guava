package cn.nextop.guava.widgets.slider.render;
 ...
 * @author jonny
 */
public abstract class AbstractXSliderWidget extends Figure {
	// Default Value
	 ...
	 * 
	 */
	public AbstractXSliderWidget(String name) {
		this(name, true, true);
	}
	
	public AbstractXSliderWidget(String name, boolean m1, boolean m2) {
		this.name = name;
