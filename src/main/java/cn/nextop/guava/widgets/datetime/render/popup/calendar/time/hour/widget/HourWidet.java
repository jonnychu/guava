...
import static cn.nextop.guava.widgets.datetime.action.actor.ActorManager.ActionType.TIME_HOUR;
...
public class HourWidet extends AbstractTimeWidget {
	...
	public void handleMouseReleased(MouseEvent event) {
		...
		.submit(new Event(EventType.COMMON, TIME_HOUR, this, time, this))
